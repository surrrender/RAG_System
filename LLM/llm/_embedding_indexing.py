...
def load_embedding_indexing_symbols() -> tuple[object, object, object, object]:
    try:
    ...
    return build_default_embedder, build_default_reranker, initialize_chunk_index, search_chunks
